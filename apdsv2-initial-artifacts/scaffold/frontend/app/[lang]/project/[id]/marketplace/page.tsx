...
import { ShieldCheck, Download, Activity, PieChart, RefreshCw, Edit3 } from 'lucide-react';
...
export default function InternalMarketplaceEditor({ params }: { params: any }) {
      ...
      <div className="max-w-7xl mx-auto relative z-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="glass-blue-card p-8 md:p-10 space-y-8 relative overflow-hidden group">
              <div className="absolute top-4 right-4 opacity-0 group-hover:opacity-100 transition-opacity">
                <button className="p-2 bg-white/10 rounded-lg hover:bg-white/20"><Edit3 className="w-4 h-4 text-white" /></button>
              </div>
            ...
            <div className="glass-blue-card p-8 md:p-10 space-y-8 relative overflow-hidden group">
              ...
              <div>
                <h2 className="text-2xl font-syne font-bold text-white flex items-center gap-2 mb-2">
                  <PieChart className="w-6 h-6 text-[#5EC8F2]" /> {dict?.marketplace?.yieldSimulator || 'Yield Simulator (Editor)'}
                </h2>
