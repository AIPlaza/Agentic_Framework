...
export function RACERTable({ indicators, projectId }: { indicators: any[]; projectId: string }) {
  ...
  if (data.length === 0) {
    return (
      <div className="text-center p-8 bg-[#020624]/60 rounded-2xl border border-white/10">
  ...
  return (
    <div className="overflow-x-auto rounded-2xl border border-white/10 bg-[#020624]/40 backdrop-blur-xl">
